 ...
 * </p>
 * <ul>
 *   <li>{@link at.ac.tuwien.big.momot.lang.momot.impl.ModuleOrchestrationImpl#getBackend <em>Backend</em>}</li>
...
{
  /**
   * The cached value of the '{@link #getBackend() <em>Backend</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getBackend()
   * @generated
   ...
   * @generated
   */
  public NotificationChain basicSetBackend(XExpression newBackend, NotificationChain msgs)
  {
    XExpression oldBackend = backend;
    backend = newBackend;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MomotPackage.MODULE_ORCHESTRATION__BACKEND, oldBackend, newBackend);
   ...
   */
  @Override
  public void setBackend(XExpression newBackend)
  {
    if (newBackend != backend)
    {
      NotificationChain msgs = null;
      if (backend != null)
        msgs = ((InternalEObject)backend).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MomotPackage.MODULE_ORCHESTRATION__BACKEND, null, msgs);
      if (newBackend != null)
        msgs = ((InternalEObject)newBackend).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MomotPackage.MODULE_ORCHESTRATION__BACKEND, null, msgs);
      msgs = basicSetBackend(newBackend, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MomotPackage.MODULE_ORCHESTRATION__BACKEND, newBackend, newBackend));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MomotPackage.MODULE_ORCHESTRATION__BACKEND:
  ...
  public void eSet(int featureID, Object newValue)
  {
    ...
    {
      case MomotPackage.MODULE_ORCHESTRATION__BACKEND:
        setBackend((XExpression)newValue);
        return;
      case MomotPackage.MODULE_ORCHESTRATION__MODULES:
