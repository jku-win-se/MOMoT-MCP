...
public class MOMoTParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MOMoTGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getModuleOrchestrationAccess().getGroup_1(), "rule__ModuleOrchestration__Group_1__0");
			...
			builder.put(grammarAccess.getModuleOrchestrationAccess().getGroup_7(), "rule__ModuleOrchestration__Group_7__0");
			...
			builder.put(grammarAccess.getModuleOrchestrationAccess().getBackendAssignment_1_2(), "rule__ModuleOrchestration__BackendAssignment_1_2");
			builder.put(grammarAccess.getModuleOrchestrationAccess().getModulesAssignment_4(), "rule__ModuleOrchestration__ModulesAssignment_4");
			builder.put(grammarAccess.getModuleOrchestrationAccess().getUnitsToRemoveAssignment_5_2(), "rule__ModuleOrchestration__UnitsToRemoveAssignment_5_2");
			builder.put(grammarAccess.getModuleOrchestrationAccess().getNonSolutionParametersAssignment_6_2(), "rule__ModuleOrchestration__NonSolutionParametersAssignment_6_2");
			builder.put(grammarAccess.getModuleOrchestrationAccess().getParameterValuesAssignment_7_3(), "rule__ModuleOrchestration__ParameterValuesAssignment_7_3");
